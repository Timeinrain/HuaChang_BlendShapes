...
public class BlendShapeMappings : ScriptableObject
{
    ...
    public List<Mapping> Mappings = new List<Mapping>
    {
        ...
        new Mapping { location = ARKitBlendShapeLocation.BrowDownLeft, name = $"{BLENDSHAPE_EXPRESSION}browDown_L" },
        new Mapping { location = ARKitBlendShapeLocation.BrowDownRight , name = $"{BLENDSHAPE_EXPRESSION}browDown_R" },
        new Mapping { location = ARKitBlendShapeLocation.BrowInnerUp , name = $"{BLENDSHAPE_EXPRESSION}browInnerUp" },
        new Mapping { location = ARKitBlendShapeLocation.BrowOuterUpLeft , name = $"{BLENDSHAPE_EXPRESSION}browOuterUp_L" },
        new Mapping { location = ARKitBlendShapeLocation.BrowOuterUpRight , name = $"{BLENDSHAPE_EXPRESSION}browOuterUp_R" },
        ...
        new Mapping { location = ARKitBlendShapeLocation.EyeLookDownLeft , name = $"{BLENDSHAPE_EXPRESSION}eyeLookDown_L" },
        new Mapping { location = ARKitBlendShapeLocation.EyeLookDownRight , name = $"{BLENDSHAPE_EXPRESSION}eyeLookDown_R" },
        new Mapping { location = ARKitBlendShapeLocation.EyeLookInLeft , name = $"{BLENDSHAPE_EXPRESSION}eyeLookIn_L" },
        new Mapping { location = ARKitBlendShapeLocation.EyeLookInRight , name = $"{BLENDSHAPE_EXPRESSION}eyeLookIn_R" },
        new Mapping { location = ARKitBlendShapeLocation.EyeLookOutLeft , name = $"{BLENDSHAPE_EXPRESSION}eyeLookOut_L" },
        new Mapping { location = ARKitBlendShapeLocation.EyeLookOutRight , name = $"{BLENDSHAPE_EXPRESSION}eyeLookOut_R" },
        new Mapping { location = ARKitBlendShapeLocation.EyeLookUpLeft , name = $"{BLENDSHAPE_EXPRESSION}eyeLookUp_L" },
        new Mapping { location = ARKitBlendShapeLocation.EyeLookUpRight , name = $"{BLENDSHAPE_EXPRESSION}eyeLookUp_R" },
        ...
        new Mapping { location = ARKitBlendShapeLocation.EyeWideLeft , name = $"{BLENDSHAPE_EXPRESSION}eyeWide_L" },
        new Mapping { location = ARKitBlendShapeLocation.EyeWideRight , name = $"{BLENDSHAPE_EXPRESSION}eyeWide_R" },
